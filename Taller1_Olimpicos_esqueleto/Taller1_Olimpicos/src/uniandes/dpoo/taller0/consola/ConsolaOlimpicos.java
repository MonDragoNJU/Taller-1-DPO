...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisConAtleta()
	{
		System.out.println("\n" + "Pais al que pertenece el ateleta" + "\n");
		
		String nombreAtleta = input("Por favor ingrese el nombre del atleta");
		String nombre_pais = calculadora.PaisConAtleta(nombreAtleta);
		
		System.out.println("\n" + "El Pais del atleta " + nombreAtleta + " es " + nombre_pais);
